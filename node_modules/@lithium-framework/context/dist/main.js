...
$parcel$export(module.exports, "createStorage", () => $222420d50129cd35$export$d184a47a971dd4b9);

class $4d96a1d56f6dde13$export$98c71376181af907 extends Map {
    /**
   ...
   */ static init(records, validator) {
        return new $4d96a1d56f6dde13$export$98c71376181af907(records, validator);
    }
    /**
   ...
   */ constructor(records, validator){
        ...
        if (records) Object.keys(records).forEach((key)=>{
            this.set(key, (0, $8zHUo$lithiumframeworkstate.createState)(records[key]));
        });
    }
    /**
...
function $222420d50129cd35$export$d184a47a971dd4b9(records = {}, stateValidator) {
    // Création d'un proxy contenant le stockage
    return new Proxy((0, $4d96a1d56f6dde13$export$98c71376181af907).init(records, stateValidator), {
        /**
